  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20 relative z-10">
        ...
        >
          <span className="label-micro block mb-8 opacity-40">System Usage Directives</span>
          <h1 className="h1-hero text-theme-text mb-12 italic">{config.pages?.terms?.title || 'Terms of Service'}</h1>
          <RichTextRenderer blocks={config.pages?.terms?.content || []} />
        </motion.div>
      </div>
    </div>
  </div>
